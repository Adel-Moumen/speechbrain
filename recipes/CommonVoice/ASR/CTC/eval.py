...
if __name__ == "__main__":
    ...
    # Valid data
    asr_brain.nbest_output_file = hparams["dev_nbest_file"]
    asr_brain.evaluate(
        valid_data,
        min_key="WER",
    ...
    # Test
    asr_brain.nbest_output_file = hparams["test_nbest_file"]
    asr_brain.evaluate(
        test_data,
        min_key="WER",
        test_loader_kwargs=hparams["test_dataloader_opts"],
